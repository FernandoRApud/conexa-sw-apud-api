...
import {
  getAllPeoples, getPeoplesByPage, getPeoplesBySearch, getPeoplesBySearchAndPage, getPeople, batchHomeworld,
} from '../services/people.services';

// batchHomeworld, batchFilms, batchSpecies, batchVehicles, batchStarships,
...
it('should return homeworld batching data of people specific', async () => {
  ...
  expect(batch).toContainEqual(expect.objectContaining({ name: expect.any(String) }));
}, 20000);
